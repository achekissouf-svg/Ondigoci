...
<div class="container py-5">
    <div class="row mb-4 align-items-center">
        <div class="col">
            <h1 class="fw-bold" style="color: #1e5a9e;">Commandes de ma boutique <i class="fas fa-store ms-2"></i></h1>
            <p class="text-muted">
                @if($boutique)
                    <strong>{{ $boutique->nom_boutique }}</strong> — commandes reçues de vos clients.
                @else
                    Votre boutique n'a pas encore de profil vendeur actif.
                @endif
            </p>
        </div>
        <div class="col-auto">
            <a href="{{ route('boutique.dashboard') }}" class="btn btn-outline-secondary">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        <thead style="background: linear-gradient(135deg, #f6d365, #fda085); color: white;">
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-4 text-center">
                                    <span class="badge rounded-pill fs-6" style="background: #fda085;">
                                        {{ $ligne->quantite_ligne_commande }}
                                    </span>
                                </td>
                                <td class="px-4 text-end fw-bold" style="color: #1e5a9e;">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                    <div class="card-body text-end">
                        <p class="text-muted mb-1">Total de mes ventes</p>
                        <h3 class="fw-bold" style="color: #fda085;">
